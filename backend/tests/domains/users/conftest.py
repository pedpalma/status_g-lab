"""Fixtures do domínio users. Segue o mesmo padrão de
tests/domains/auth/conftest.py: app de teste isolado, só com o router
...
def usuario_ativo(db: Session) -> Generator[User, None, None]:
    user = User(
        name="Tecnico Teste",
        email="tecnico.teste2@glab.com.br",
        password_hash=hash_password("senha123"),
        role="tecnico",
        is_active=True,
    )
